...
const CORRECT_LABELS = [
  ...
  { matchNumber: 74,  label: '1E vs 3er'   },
  { matchNumber: 75,  label: '1F vs 2C'    },
  { matchNumber: 76,  label: '1C vs 2F'    },
  { matchNumber: 77,  label: '1I vs 3er'   },
  { matchNumber: 78,  label: '2E vs 2I'    },
  { matchNumber: 79,  label: '1A vs 3er'   },
  { matchNumber: 80,  label: '1L vs 3er'   },
  { matchNumber: 81,  label: '1D vs 3er'   },
  { matchNumber: 82,  label: '1G vs 3er'   },
  { matchNumber: 83,  label: '2K vs 2L'    },
  { matchNumber: 84,  label: '1H vs 2J'    },
  { matchNumber: 85,  label: '1B vs 3er'   },
  { matchNumber: 86,  label: '1J vs 2H'    },
  { matchNumber: 87,  label: '1K vs 3er'   },
